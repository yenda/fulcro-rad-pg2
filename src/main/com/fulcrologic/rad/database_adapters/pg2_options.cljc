(ns com.fulcrologic.rad.database-adapters.pg2-options
...
(def fk-attr
  ...
  :com.fulcrologic.rad.database-adapters.pg2/fk-attr)
...
(def max-length
  ...
  :com.fulcrologic.rad.database-adapters.pg2/max-length)

(def ^:deprecated sql->form-value "DEPRECATED. See sql->model-value."
  :com.fulcrologic.rad.database-adapters.pg2/sql->form-value)

(def ^:deprecated form->sql-value "DEPRECATED. See model->sql-value."
  :com.fulcrologic.rad.database-adapters.pg2/form->sql-value)
...
(def model->sql-value
  ...
  is :com.fulcrologic.rad.database-adapters.pg2/form->sql-value."
  :com.fulcrologic.rad.database-adapters.pg2/form->sql-value)
...
(def sql->model-value
  "Attribute option. A `(fn [sql-value] clojure-type)`. If defined, then this
   ...
   WARNING: The keyword name of this option does not match this option name.
   is :com.fulcrologic.rad.database-adapters.pg2/sql->form-value."
  :com.fulcrologic.rad.database-adapters.pg2/sql->form-value)
...
(def connection-pools
  ...
  :com.fulcrologic.rad.database-adapters.pg2/connection-pools)
...
(def delete-orphan?
   ...
   **Re-parenting:** To move a child from one parent to another, update the child's
   ...
   ```"
  :com.fulcrologic.rad.database-adapters.pg2/delete-orphan?)
...
(def order-by
  ...
  :com.fulcrologic.rad.database-adapters.pg2/order-by)
