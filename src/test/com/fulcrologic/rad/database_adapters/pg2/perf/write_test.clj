(ns ^:integration com.fulcrologic.rad.database-adapters.pg2.perf.write-test
  "Performance benchmarks for save-form! writes.
   ...
   clojure -A:test:dev -M -e \"(require 'com.fulcrologic.rad.database-adapters.pg2.perf.write-test) (com.fulcrologic.rad.database-adapters.pg2.perf.write-test/run-all-benchmarks)\""
  (:require
