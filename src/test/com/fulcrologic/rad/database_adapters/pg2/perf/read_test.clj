(ns com.fulcrologic.rad.database-adapters.pg2.perf.read-test
  "Performance benchmarks for Pathom3 resolver reads.
   ...
   clojure -A:test:dev -M -e \"(require 'com.fulcrologic.rad.database-adapters.pg2.perf.read-test) (com.fulcrologic.rad.database-adapters.pg2.perf.read-test/run-all-benchmarks)\""
  (:require
