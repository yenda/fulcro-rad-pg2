(ns com.fulcrologic.rad.database-adapters.pg2.value-transformer-test
...
(def entity-secret
  {::attr/qualified-key :entity/secret
   ...
   ::attr/schema :production
   ::attr/identities #{:entity/id}
   ;; NOTE: The actual RAD key is ::rad.pg2/form->sql-value (write direction)
   ::rad.pg2/form->sql-value encrypt-value})
...
(def entity-tags
  {::attr/qualified-key :entity/tags
   ...
   ::rad.pg2/form->sql-value serialize-tags
   ;; Read: comma-separated string -> vector (not currently used by write, only read)
   ::rad.pg2/sql->form-value deserialize-tags})
...
(def entity-metadata
  {::attr/qualified-key :entity/metadata
   ...
   ::attr/schema :production
   ::attr/identities #{:entity/id}
   ::rad.pg2/form->sql-value json-encode
   ::rad.pg2/sql->form-value json-decode})
...
(def entity-optional
  {::attr/qualified-key :entity/optional
   ...
   ::attr/schema :production
   ::attr/identities #{:entity/id}
   ::rad.pg2/form->sql-value (fn [v] (if v (str/upper-case v) nil))})
