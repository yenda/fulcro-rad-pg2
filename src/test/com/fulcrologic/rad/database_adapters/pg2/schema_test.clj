(ns com.fulcrologic.rad.database-adapters.pg2.schema-test
  ...
  (:require
   ...
   [com.fulcrologic.rad.database-adapters.pg2.schema :as schema]
...
(deftest column-name-respects-explicit-column-name
  (testing "column-name uses explicit ::rad.pg2/column-name when provided"
...
(def gen-scalar-attr
  ...
  (gen/let [qk gen-qualified-keyword
    ...
    (cond-> {::attr/qualified-key qk
      ...
      has-explicit-col? (assoc ::rad.pg2/column-name explicit-col))))
...
(defspec explicit-column-name-used-when-provided 30
  (prop/for-all [qk gen-qualified-keyword
                ...
                (let [attr {::attr/qualified-key qk
                            ::attr/type :string
                            ::attr/cardinality :one
                            ::rad.pg2/column-name explicit-col}
