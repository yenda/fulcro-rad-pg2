(ns com.fulcrologic.rad.database-adapters.sql.delete-orphan-edge-cases-test
...
(def task-project
  {::attr/qualified-key :task/project
   ...
   ::attr/schema :production
   ::attr/identities #{:task/id}
   ::rad.sql/column-name "project_id"})
