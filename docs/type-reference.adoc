...
(defattr order-line-items :order/line-items :ref
  {::attr/cardinality :many
   ...
   ::attr/schema :production
   ::attr/identities #{:order/id}
   ::sql/fk-attr :line-item/order})  ; FK is stored by :line-item/order
...
(defattr document-metadata :document/metadata :ref
  {::attr/cardinality :one
   ...
   ::sql/fk-attr :metadata/document   ; FK stored by :metadata/document
   ::sql/delete-orphan? true})        ; Delete orphaned metadata
----
